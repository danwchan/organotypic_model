...
```{r knitr-options, message=FALSE, echo=FALSE}
...
```{r summary-plot, message=FALSE, fig.width=12, fig.height=10}
...
```{r Post-hoc-pairwise, message=FALSE}
...
```{r overview-plot, fig.width=7, fig.height=7}
