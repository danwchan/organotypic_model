...
ggsave("Figures/rafts_mutants_cfu.tiff", plot = main_fig, width = 30, height = 15, units = "cm", dpi = 1200) #this code is only evaluate when the script us run ourside of knitr
